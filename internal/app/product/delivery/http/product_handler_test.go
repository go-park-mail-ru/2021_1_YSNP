...
func TestProductHandler_MainPageHandler_Error(t *testing.T) {
	t.Parallel()
	...
	prodUcase.EXPECT().ListLatest(&userID, gomock.Eq(page)).Return(nil, errors.UnexpectedInternal(fmt.Errorf("")))
...
func TestProductHandler_SellerAdHandler_Success(t *testing.T) {
	t.Parallel()
	...
	prodHandler.SellerAdHandler(w, r.WithContext(ctx))
	assert.Equal(t, http.StatusOK, w.Code)
}

func TestProductHandler_SellerAdHandler_NoLogger(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_SellerAdHandler_DecodeError(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_SellerAdHandler_Error(t *testing.T) {
	t.Parallel()
	...
	prodUcase.EXPECT().UserAdList(userID, gomock.Eq(page)).Return(nil, errors.UnexpectedInternal(fmt.Errorf("")))
...
func TestProductHandler_UserAdHandler_Error(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_UserFavoriteHandler_Error(t *testing.T) {
	t.Parallel()
	...
	prodUcase.EXPECT().GetUserFavorite(userID, gomock.Eq(page)).Return(nil, errors.UnexpectedInternal(fmt.Errorf("")))
...
func TestProductHandler_DislikeProductHandler_Error(t *testing.T) {
	t.Parallel()
	...
	prodUcase.EXPECT().DislikeProduct(gomock.Eq(uint64(1)), gomock.Eq(uint64(0))).Return(errors.UnexpectedInternal(fmt.Errorf("")))
...
func TestProductHandler_TrendsPageHandler_NoAuth(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_TrendsPageHandler_NoLogger(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_ProductTrendsHandler_Success(t *testing.T) {
	t.Parallel()
	...
	prodUcase.EXPECT().RecommendationList(uint64(0), uint64(1)).Return([]*models.ProductListData{}, nil)

	prodHandler.ProductTrendsHandler(w, r.WithContext(ctx))

	assert.Equal(t, http.StatusOK, w.Code)
}

func TestProductHandler_ProductTrendsHandler_Error(t *testing.T) {
	t.Parallel()
	...
	prodUcase.EXPECT().RecommendationList(uint64(0), uint64(1)).Return(nil, errors.UnexpectedInternal(fmt.Errorf("")))
...
func TestProductHandler_ProductCloseHandler_NoLogger(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_ProductCloseHandler_Error(t *testing.T) {
	t.Parallel()
	...
	prodUcase.EXPECT().Close(prodTest.ID, uint64(1)).Return(nil)
	prodUcase.EXPECT().GetProductReviewers(prodTest.ID, uint64(1)).Return(nil, errors.UnexpectedInternal(fmt.Errorf("")))
...
func TestProductHandler_ProductEditHandler_NoLogger(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_SetProductBuyer_NoLogger(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_CreateProductReview_Error(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_GetUserReviews_Error(t *testing.T) {
	t.Parallel()
...
func TestProductHandler_GetWaitingReviews_Error(t *testing.T) {
	t.Parallel()
